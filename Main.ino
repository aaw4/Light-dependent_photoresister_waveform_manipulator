...
bool *PHR = new boolean[12];   // photoresistor value array

bool *BS  = new boolean [4];   // button value array
int  *KN  = new int  [6];   // knob value array

int lightCal;   // PHR calibration value
const int sensitivity = 120;    // PHR activation sensitivity
...
extern void updatePHR(boolean* PHR)
{
    for(int rep = 0; rep< 12; rep++)
    {
      
        //something like this
        PHR[rep] = ((analogRead(rep + STARTPHRPIN) <= (lightCal - sensitivity)) && !PHR[rep]);      
